...
const playSoalAudio = new Audio('/assets/audio/soal/penjumlahan10/soalKetiga.mp3')
const playCaraA = new Audio('/assets/audio/soal/penjumlahan10/7+3.mp3')
