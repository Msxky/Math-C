...
const playSoalAudio = new Audio('/assets/audio/soal/pengurangan20/soalKedua.mp3')
const playCaraA = new Audio('/assets/audio/soal/pengurangan20/12-6.mp3')
const option1A = new Audio('/assets/audio/soal/number/7.mp3');
const option2A = new Audio('/assets/audio/soal/number/9.mp3');
const option3A = new Audio('/assets/audio/soal/number/6.mp3');
...
function option3(){
  ...
  setTimeout(function() {
    location.href="/assets/content/soal/soal-3-pengurangan20.html"
  }, 8000);
}
