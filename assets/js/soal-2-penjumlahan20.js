...
const playSoalAudio = new Audio('/assets/audio/soal/penjumlahan20/soalKedua.mp3')
const playCaraA = new Audio('/assets/audio/soal/penjumlahan20/14+6.mp3')
const option1A = new Audio('/assets/audio/soal/number/20.mp3');
const option2A = new Audio('/assets/audio/soal/number/6.mp3');
