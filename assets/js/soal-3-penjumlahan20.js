...
const playSoalAudio = new Audio('/assets/audio/soal/penjumlahan20/soalKetiga.mp3')
const playCaraA = new Audio('/assets/audio/soal/penjumlahan20/13+4.mp3')
const option1A = new Audio('/assets/audio/soal/number/11.mp3');
const option2A = new Audio('/assets/audio/soal/number/7.mp3');
const option3A = new Audio('/assets/audio/soal/number/17.mp3');
